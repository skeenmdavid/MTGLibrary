...
builder.Services.Configure<MTGLibraryDatabaseSettings>(builder.Configuration.GetSection("MTGLibraryDatabase"));
...
builder.Services.AddScoped<IDatabaseAccess, MTGLibraryMDB>();
